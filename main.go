...
func getusers(c *gin.Context) {
	client, err := mongo.NewClient(options.Client().ApplyURI("mongodb+srv://sahitya:appointy@appointy.qaunz.mongodb.net/Appointy?retryWrites=true&w=majority"))
	if err != nil {
		log.Fatal(err)
	}
...
func postusers(c *gin.Context) {
	...
	c.IndentedJSON(http.StatusCreated, "User has been Added")
}
